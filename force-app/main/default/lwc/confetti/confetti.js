				...
				function s(n, r, a, s, u) {
					...
					var y,
						v =
							...
							e.exports.Promise
								? new e.exports.Promise(y)
								: (y(i, i), null));
					return (
						s && t.addEventListener("resize", g, !1),
						{
						...
						for (
							...
							M.push(
								...
								(P = w.spread * (Math.PI / 180)),
								{
									...
									velocity:
										0.5 * w.startVelocity +
										Math.random() * w.startVelocity,
									angle2D: -A + (0.5 * P - Math.random() * P),
